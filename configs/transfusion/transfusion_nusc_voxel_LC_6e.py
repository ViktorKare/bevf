...
#load_from = None#'work_dirs/transfusion_nusc_voxel_L/epoch_20.pth'
#load_img_from = None#'work_dirs/mask_rcnn_r50_fpn_1x_nuim/epoch_12.pth'
resume_from = 'work_dirs/transfusion_nusc_voxel_LC_6e/latest.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 8)
